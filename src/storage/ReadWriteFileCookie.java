...
public class ReadWriteFileCookie implements IReadWriteFileCookie {
    ...
    private List<Cookie> getDefaultCookies() {
        ...
        defaultCookies.add(new Cookie("1", "bánh mỳ", 30, 15, LocalDate.now(), Sales.SALE10, CookieSize.SMALLSIZE));
        defaultCookies.add(new Cookie("2", "gato", 50, 20, LocalDate.now(), Sales.SALE10, CookieSize.BIGSIZE));
        defaultCookies.add(new Cookie("3", "su kem", 25, 15, LocalDate.now(), Sales.SALE10, CookieSize.SMALLSIZE));
